...
echo_and_run cd "/home/nvidia/sdc-ernie/src/racecar/rospyext"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/nvidia/sdc-ernie/src/racecar/rospyext/setup.py" \
    build --build-base "/home/nvidia/sdc-ernie/build/racecar/rospyext" \
    install \
    $DESTDIR_ARG \
