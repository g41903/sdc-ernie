...
echo_and_run cd "/home/nvidia/sdc-ernie/src/racecar/ros_numpy"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/nvidia/sdc-ernie/src/racecar/ros_numpy/setup.py" \
    build --build-base "/home/nvidia/sdc-ernie/build/racecar/ros_numpy" \
    install \
    $DESTDIR_ARG \
