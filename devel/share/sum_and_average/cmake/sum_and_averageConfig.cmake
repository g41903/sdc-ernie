...
if("TRUE" STREQUAL "TRUE")
  set(sum_and_average_SOURCE_PREFIX /home/nvidia/sdc-ernie/src/racecar/sum_and_average)
  set(sum_and_average_DEVEL_PREFIX /home/nvidia/sdc-ernie/devel)
  ...
  set(sum_and_average_INSTALL_PREFIX /home/nvidia/sdc-ernie/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sum_and_average' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/sdc-ernie/src/racecar/sum_and_average/${idir}'.  Ask the maintainer 'Michael Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sum_and_average_dep}_FOUND)
      find_package(${sum_and_average_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sum_and_average_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
