...
if("TRUE" STREQUAL "TRUE")
  set(ackermann_cmd_mux_SOURCE_PREFIX /home/nvidia/sdc-ernie/src/racecar/ackermann_cmd_mux)
  set(ackermann_cmd_mux_DEVEL_PREFIX /home/nvidia/sdc-ernie/devel)
  ...
  set(ackermann_cmd_mux_INSTALL_PREFIX /home/nvidia/sdc-ernie/install)
...
if(NOT "/home/nvidia/sdc-ernie/devel/include;/home/nvidia/sdc-ernie/src/racecar/ackermann_cmd_mux/include " STREQUAL " ")
  set(ackermann_cmd_mux_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/sdc-ernie/devel/include;/home/nvidia/sdc-ernie/src/racecar/ackermann_cmd_mux/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Boulet <boulet@ll.mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/sdc-ernie/src/racecar/ackermann_cmd_mux/${idir}'.  Ask the maintainer 'Michael Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
