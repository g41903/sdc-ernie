...
if("TRUE" STREQUAL "TRUE")
  set(ros_numpy_SOURCE_PREFIX /home/nvidia/sdc-ernie/src/racecar/ros_numpy)
  set(ros_numpy_DEVEL_PREFIX /home/nvidia/sdc-ernie/devel)
  ...
  set(ros_numpy_INSTALL_PREFIX /home/nvidia/sdc-ernie/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ros_numpy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/sdc-ernie/src/racecar/ros_numpy/${idir}'.  Ask the maintainer 'Eric Wieser <wieser@mit.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ros_numpy_dep}_FOUND)
      find_package(${ros_numpy_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ros_numpy_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
